...
const ChannelSchema = new Schema(
    {
        channelType: {
            type: String,
            required: "El 'channelType' es requerido",
            enum: channelConfig.channelType,
        },
        // CLIENT
        clientEmail: {
            type: String,
        ...
        channelName: {
            ...
            match: [
                channelConfig.regExChName,
                "El 'channelName' no es válido.",
            ],
        ...
        channelLanguage: {
            type: String,
            required: true,
            enum: channelConfig.channelLanguage,
        },
        channelCategory: {
            type: String,
            required: true,
            enum: channelConfig.channelCategory,
        },
        clientInterestingNow: {
            type: Boolean,
            required: false,
            default: false,
        },
        ...
        channelImg: {
            type: String,
            required: false,
            default: "img_channel_default.jpg",
        },
...
ChannelSchema.post("save", (doc) => {
    ...
    if (_ENV == "development") {
        ...
        console.log(
            "clientType: ",
            clientConfig.arrClientTypes[
                channelConfig.arrChannelTypes.indexOf(doc.channelType)
            ]
        );
    }
});
ChannelSchema.virtual("clientType").get(function () {
    return clientConfig
        .arrClientTypes[channelConfig.arrChannelTypes.indexOf(this.channelType)];
});
